...
def generate_map():
    ...
    for key, value in result.items():
        temp_state_info = temp_state_info + key + ': { name: "' + key + '", description: "' + value + '", color : "' + value + '", hover_color: "default", url: "https://www.google.com/maps/@37.6,-95.665,3z" },'
